...
export default function RoadtripCard({
  ...
  return (
    <>
      <div className="mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow relative">
        {isOwner && (
        ...
        {roadtripMenuOpen && (
          <ul
            ...
            className="absolute right-4 top-1 mt-8 bg-white rounded-md shadow-lg overflow-hidden w-32 z-20"
          >
            <button
              onClick={(e) => {
                e.preventDefault();
